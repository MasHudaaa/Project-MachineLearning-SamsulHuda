...
# Menampilkan Banner Gambar/GIF Air Biar Lebih Hidup
st.image("https://images.unsplash.com/photo-1518156677180-95a2893f3e9f?q=80&w=1000", use_container_width=True)

st.write("### ⚙️ Masukkan Parameter Indikator Air:")
